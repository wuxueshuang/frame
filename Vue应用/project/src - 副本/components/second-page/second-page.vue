  ...
  <div class="second-page">
        ...
        <div class="mine-content">
            <div :class="clsName" v-for="item,index in listObj.list">
                ...
                <recommend-footer v-if="!clsName.includes('kind5')" :itemData="item" :type="type"></recommend-footer>    
            </div>  <!---->
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            clsName(){
                if(this.listObj.type === '阅读'){
                    return 'kind1 same'
                }else if(this.listObj.type === 'OWSPACE'){
                    return 'kind2 same'
                }else if(this.listObj.type === '创意'){
                    return 'kind3 same'
                }else if(this.listObj.type === '微信'){
                    return 'kind4 same'
                }else if(this.listObj.type === '音乐'){
                    return 'kind5 same'
                }else if(this.listObj.type === '其他'){
                    return 'kind1 same'
                }
            },
            itemData(){
        ...
        methods:{
            getSecondData(){
                ...
                Axios.get(
                    'http://localhost:3200/api/hometitle'
                )
                .then((data) => {
